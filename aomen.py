...
title = '<!DOCTYPE html><html><head><meta charset="utf-8"><title>澳门图片</title></head><body><style type="text/css">.imgblock img{width:50%;height:500px;flost:left;}</style><h1 align="center" ; font-size:50px">{updatetime}</h1><h1 align="center" style="color:red ; font-size:50px">澳门图片</h1>'
