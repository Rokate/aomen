...
if pic01.status_code == 200:
    ...
    if err:
        ...
        url01 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url01 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic01.jpg'
...
if pic02.status_code == 200:
    ...
    if err:
        ...
        url02 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url02 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic02.jpg'
...
if pic03.status_code == 200:
    ...
    if err:
        ...
        url03 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url03 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic03.jpg'
...
if pic04.status_code == 200:
    ...
    if err:
        ...
        url04 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url04 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic04.jpg'
...
if pic05.status_code == 200:
    ...
    if err:
        ...
        url05 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url05 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic05.jpg'
...
if pic06.status_code == 200:
    ...
    if err:
        ...
        url06 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url06 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic06.jpg'
...
if pic19.status_code == 200:
    ...
    if err:
        ...
        url19 = "https://i0.wp.com/telegra.ph" + r[0].get("src")
else:
    print ('error')
    url19 = 'https://2img.net/h/raw.githubusercontent.com/Rokate/imagebackup/main/aomen/pic19.jpg'

#保存html文本
htmlconten = f'<div align="center" class="imgblock"><a href="{url01}" target="_blank"><img src="{url01}" / ><a href="{url02}" target="_blank"><img src="{url02}" / ></div><div align="center" class="imgblock"><a href="{url03}" target="_blank"><img src="{url03}" / ><a href="{url04}" target="_blank"><img src="{url04}" / ></div><div align="center" class="imgblock"><a href="{url05}" target="_blank"><img src="{url05}" / ><a href="{url06}" target="_blank"><img src="{url06}" / ></div><div align="center" class="imgblock"><a href="{url07}" target="_blank"><img src="{url07}" / ><a href="{url08}" target="_blank"><img src="{url08}" / ></div><div align="center" class="imgblock"><a href="{url09}" target="_blank"><img src="{url09}" / ><a href="{url10}" target="_blank"><img src="{url10}" / ></div><div align="center" class="imgblock"><a href="{url11}" target="_blank"><img src="{url11}" / ><a href="{url12}" target="_blank"><img src="{url12}" / ></div><div align="center" class="imgblock"><a href="{url13}" target="_blank"><img src="{url13}" / ><a href="{url14}" target="_blank"><img src="{url14}" / ></div><div align="center" class="imgblock"><a href="{url15}" target="_blank"><img src="{url15}" / ><a href="{url16}" target="_blank"><img src="{url16}" / ></div><div align="center" class="imgblock"><a href="{url17}" target="_blank"><img src="{url17}" / ><a href="{url18}" target="_blank"><img src="{url18}" / ></div><div align="center" class="imgblock"><a href="{url19}" target="_blank"><img src="{url19}" / ></div></body></html>'
title = '<!DOCTYPE html><html><head><meta charset="utf-8"><title>澳门图片</title></head><body><style type="text/css">.imgblock img{width:33%;height:500px;flost:left;}</style><h1 align="center" style="color:red ; font-size:50px">图片列表</h1>'
